...
- [IBM API Connect](#ibm-api-connect)
	- [Add OAuth Security to your API and use Lifecycle Controls to Version Your API](#add-oauth-security-to-your-api-and-use-lifecycle-controls-to-version-your-api)
- [Table of Contents](#table-of-contents)
- [1. Introduction ](#1-introduction-)
- [2. Configure a New OAuth 2.0 Provider API ](#2-configure-a-new-oauth-20-provider-api-)
- [2a. Configure Authentication URL User Registry ](#2a-configure-authentication-url-user-registry-)
- [3. Create an OAuth Service ](#3-create-an-oauth-service-)
- [4. Add the OAuth Service to the Sandbox Catalog ](#4-add-the-oauth-service-to-the-sandbox-catalog-)
- [5. Create a New Version of the Customer API ](#5-create-a-new-version-of-the-customer-api-)
	- [5a. Add OAuth Security to the Customer API ](#5a-add-oauth-security-to-the-customer-api-)
- [6. Create a New Product ](#6-create-a-new-product-)
- [7. Stage the Product to your API Manager Environment ](#7-stage-the-product-to-your-api-manager-environment-)
- [8. Supersede Version 1.0.0 of the Product ](#8-supersede-version-100-of-the-product-)
- [9. Test the OAuth Configuration ](#9-test-the-oauth-configuration-)
	- [Summary](#summary)
...
5\. Enter **App Registry** for the **Title**, `https://jsonplaceholder.typicode.com/users` for the **Url**, and **App Registry** for the **Display name**. Click **Save**.
...
2\. Select **Sandbox** for the target **Catalog**.

Note: IBM API Connect allows you to publish products to specific gateways associated with the Catalog.

![alt text][pic60-1]

3\. Finally click **Stage**.  

![alt text][pic60-2]

[pic59]: images/59.png
[pic60-1]: images/60-1.png
[pic60-2]: images/60-2.png
