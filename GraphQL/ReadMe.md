...
- Title: accounts
- GraphQL server URL: <https://graphql-test-server-graphql-test-server.apps.cody.coc-ibm.com/accounts/graphql>
...
**Comment to Students:** An issue has been noted that the editor does not render and you are not able to enter account and shipping address detail.<br><br>
As a workaround, **Open a new tab** with the GraphiQL URL, i.e: <https://apim-demo-gw-gateway-cp4i-apic.apps.ventress.coc-ibm.com/ventressX-porg/sandbox/accounts/graphql><br> Just replace **ventressX** with your assigned user and check if your **Client ID** is correctly set. To check just click on **"Credentials"** at the top of the screen.
